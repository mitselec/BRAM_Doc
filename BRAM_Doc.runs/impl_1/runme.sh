...
HD_PWD='D:/VHDL/BRAM_Doc/BRAM_Doc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mem_Conf_Top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Mem_Conf_Top.tcl -notrace
